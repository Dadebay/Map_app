...
class MyTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'tm': {
          'expired': 'Möhleti gutardy. Işletmek üçin administratoryňyzy birikdirmegiňizi haýyş edýäris!',
          'deleteTitle': 'Pozmak',
          'distance': 'Aralyk:',
          'lastSeen': 'Soňky mag :',
        ...
        'ru': {
          'distance': 'Расстояние :',
          'lastSeen': 'Последняя информация:',
          'expired': 'Срок действия подписки истек. Пожалуйста, подключите своего администратора, чтобы активировать его!',
          'yes': 'Да',
          'deleteTitle': 'Удалить',
          ...
          'userInfo': 'Информация о пользовател',
        ...
        'en': {
          'distance': 'Distance :',
          'lastSeen': 'Last seen:',
          'expired': 'Expired Subscription. Please connect your administrator to activate it !',
          'yes': 'Yes',
          'deleteTitle': 'Delete',
